...
@onready var _a_VSync_Mode: DebugValueSelectOptions = get_node("HSplit/Left/VSync_Mode")
@onready var _a_Window_Size: DebugValueSelectOptions = get_node("HSplit/Left/Window_Size")
