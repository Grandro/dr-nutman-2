...
class_name CompEquipmentShared
...
func init(p_entity_entity) -> void:
	_a_entity_entity_comph = p_entity_entity.comph()
	
	var anims_comp: CompAnims = _a_entity_entity_comph.get_comp("Anims")
...
func _on_Anims_anim_played(p_name: StringName) -> void:
	var anim_comp: CompAnims = _a_entity_entity_comph.get_comp("Anims")
