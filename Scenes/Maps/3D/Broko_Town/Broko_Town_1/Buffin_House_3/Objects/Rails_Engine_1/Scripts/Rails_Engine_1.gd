...
@onready var _a_Left = get_node("Left")
@onready var _a_Right = get_node("Right")

var _a_left_pushed = false
var _a_right_pushed = false
var _a_total_force = 0.0
