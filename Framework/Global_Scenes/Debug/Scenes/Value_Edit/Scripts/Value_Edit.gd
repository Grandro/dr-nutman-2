...
class_name FWDebugValueEdit

signal value_changed(p_value: Variant)

const _a_TYPE_SCENE_PATH: String = "res://Framework/Global_Scenes/Debug/Scenes/Value_Edit/Types/%s.tscn"
...
@onready var _a_Edit: FWDebugValueEditEdit = get_node("HBox/Edit")
