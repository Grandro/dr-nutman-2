...
class_name DebugCommandEditCommandTeleport

@onready var _a_Type: DebugValueSelectOptions = get_node("Window/Contents/Margin/VBox/Type")
@onready var _a_Teleportation: DebugValueSelectOptions = get_node("Window/Contents/Margin/VBox/Teleportation")
@onready var _a_Destination: DebugValueSelectOptions = get_node("Window/Contents/Margin/VBox/Destination")
@onready var _a_Troop: DebugValueSelectEdit = get_node("Window/Contents/Margin/VBox/Troop")
@onready var _a_Handle_Lost_Battle: DebugValueSelectBool = get_node("Window/Contents/Margin/VBox/Handle_Lost_Battle")
...
func _get_destination_keys() -> Array[StringName]:
	...
	match type:
		&"Map":
			var tp: StringName = _a_Teleportation.get_selected_key()
			var data: MapData = Databases.get_data_entry(&"Maps", tp)
