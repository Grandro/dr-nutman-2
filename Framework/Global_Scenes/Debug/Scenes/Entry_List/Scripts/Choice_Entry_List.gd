...
class_name FWDebugChoiceEntryList

var _a_keys_type: StringName # Map/Global

func instantiate_entry_(p_loc_id: StringName, p_value: Variant, p_name: String = "") -> FWDebugEntryListChoiceEntry:
	var instance: FWDebugEntryListChoiceEntry = instantiate_entry(p_name)
	if !_e_enumerate:
...
func instantiate_entry_from_data(p_data: Dictionary) -> FWDebugEntryListChoiceEntry:
