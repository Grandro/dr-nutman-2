...
var _a_value_edit: FWDebugValueEdit
...
func _update_value_entries() -> void:
	...
	for key: Variant in value:
		var instance: FWDebugValueEdit = _instantiate_value_edit(key)
...
func _instantiate_value_edit(p_key: Variant) -> FWDebugValueEdit:
	var instance: FWDebugValueEdit = _a_Value_Edit_Scene.instantiate()
	var child_data: FWValueEditData = _a_data.get_dic_child_data_key(p_key)
...
func _set_data(p_data: FWValueEditData) -> void:
	var child_data: Dictionary[Variant, FWValueEditData] = p_data.get_dic_child_data()
