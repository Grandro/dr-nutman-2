extends DebugDialoguesAttributesTabGeneral
class_name DebugDialoguesAttributesTabGeneralTypes

signal type_changed(p_type: StringName)

@export var _e_types: Array[StringName] = []

const _a_TYPE_LOC_ID: String = "DEBUG_DIALOGUES_ATTRIBUTES_%s"

@onready var _a_Type_Heading: Label = get_node("Margin/HSplit/Left/Type/Heading")
