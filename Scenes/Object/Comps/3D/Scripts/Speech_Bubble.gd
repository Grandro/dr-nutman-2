extends Node3D
class_name CompSpeechBubble3D

signal choice_selected(p_value: Variant)

@export var _e_margin: Vector2 = Vector2(8, 8)

@onready var _a_Panel: GUI3DPanel = get_node("Panel")
@onready var _a_Plane: MeshInstance3D = get_node("Panel/Plane")
@onready var _a_VP: VP = get_node("Panel/VP")
@onready var _a_Speech_Bubble_UI: CompSpeechBubbleUI = get_node("Panel/VP/Speech_Bubble_UI")
...
func init(p_entity: Node) -> void:
	...
	if entity_comph.has_comp("Interactions"):
		var interactions_comp: CompInteractions3D = entity_comph.get_comp("Interactions")
...
func _on_Interactions_interaction_activated(p_area: CompInteractionsInteraction3D) -> void:
