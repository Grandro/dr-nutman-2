...
class_name FWDebugCommandEditCommandDisableObject

@onready var _a_Disable: FWDebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Disable")
