...
class_name DebugCommandEditCommandShowDialogue

@onready var _a_Key_Type: DebugValueSelectOptions = get_node("Window/Contents/Margin/VBox/VBox/Key_Type")
@onready var _a_Key: DebugCommandEditCommandShowDialogueKey = get_node("Window/Contents/Margin/VBox/VBox/Key")
@onready var _a_Process_Type: DebugValueSelectOptions = get_node("Window/Contents/Margin/VBox/VBox/Process_Type")
@onready var _a_Start_Idx: DebugValueSelectNum = get_node("Window/Contents/Margin/VBox/VBox/Start_Idx")
@onready var _a_End_Idx: DebugValueSelectNum = get_node("Window/Contents/Margin/VBox/VBox/End_Idx")
@onready var _a_Layer: DebugValueSelectNum = get_node("Window/Contents/Margin/VBox/VBox/Layer")
@onready var _a_Fade_Out: DebugValueSelectBool = get_node("Window/Contents/Margin/VBox/VBox/Fade_Out")
