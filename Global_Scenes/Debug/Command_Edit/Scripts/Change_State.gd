...
class_name DebugCommandEditCommandChangeState

@onready var _a_State: DebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/State")
