extends CanvasLayer
class_name DebugGeneralTeleportSceneSelect

var _a_HBox_Entry: PackedScene = preload("res://Global_Scenes/Debug/General/Teleport_Scene/HBox_Entry.tscn")
var _a_VBox_Entry: PackedScene = preload("res://Global_Scenes/Debug/General/Teleport_Scene/VBox_Entry.tscn")
...
func _create_teleport_list() -> void:
	...
	for key: StringName in data:
		var vbox_instance: DebugGeneralTeleportSceneVBoxEntry = _a_VBox_Entry.instantiate()
		...
		for destination: StringName in data[key].get_destinations():
			...
			var hbox_instance: DebugGeneralTeleportSceneHBoxEntry = _a_HBox_Entry.instantiate()
