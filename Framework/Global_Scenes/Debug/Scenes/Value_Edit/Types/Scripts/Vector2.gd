...
class_name FWDebugValueEditTypeVector2
...
@onready var _a_X_Value: FWDebugFloatEdit = get_node("VBox/X/HBox/Value")
@onready var _a_Y_Value: FWDebugFloatEdit = get_node("VBox/Y/HBox/Value")
