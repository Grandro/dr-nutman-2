...
@export var _e_fb_child_data: FWValueEditData
@export var _e_arr_child_data: Array[FWValueEditData] = []
@export var _e_dic_child_data: Dictionary[Variant, FWValueEditData] = {}
...
func get_arr_child_data() -> Array[FWValueEditData]:
	return _e_arr_child_data

func get_arr_child_data_idx(p_idx: int) -> FWValueEditData:
	...
	return FWValueEditData.new()

func get_dic_child_data() -> Dictionary[Variant, FWValueEditData]:
	return _e_dic_child_data

func get_dic_child_data_key(p_key: Variant) -> FWValueEditData:
