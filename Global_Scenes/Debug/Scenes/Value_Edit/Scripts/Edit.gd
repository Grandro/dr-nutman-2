...
class_name DebugValueEditEdit

signal type_changed(p_type: Variant.Type)
signal remove_item_pressed()

var _a_Type_Entry_Scene: PackedScene = preload("res://Global_Scenes/Debug/Scenes/Value_Edit/Type_Entry.tscn")
var _a_Type_HSep_Scene: PackedScene = preload("res://Global_Scenes/Debug/Scenes/Value_Edit/Type_HSep.tscn")
