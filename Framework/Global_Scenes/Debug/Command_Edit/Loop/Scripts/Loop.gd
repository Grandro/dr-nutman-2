...
class_name FWDebugCommandEditCommandLoop

const _a_TYPES: Array[String] = ["For"]
const _a_TYPE_LOC_ID: String = "FW_DEBUG_CUTSCENES_%s"
...
func _get_save_data() -> Dictionary:
	var data: Dictionary = {}
	var menu: FWDebugCommandEditMenuBase = _a_menus[_a_key]
