...
class_name FWDebugLocEditorLocIDEntry

signal select_focus_entered()
signal loc_id_changed(p_loc_id: String)

var _a_loc_id: String
var _a_visible_by_loc_id: bool = true

func _ready() -> void:
	super()
	_a_Select.focus_entered.connect(_on_Select_focus_entered)

func update_display(p_group: StringName, p_type: StringName) -> void:
	var loc_id_short: String = _get_loc_id_short_group(p_group)
...
func update_visible_by_loc_id(p_group: StringName, p_type: StringName) -> void:
	if p_type == &"Map" && p_group == &"Dialogue":
		var location: StringName = Scene_Manager.get_location()
		if location.is_empty() || _has_location_prefix(p_group, location):
...
func get_loc_id() -> String:
	return _a_loc_id

func _set_visible_by_loc_id(p_visible_by_loc_id: bool) -> void:
	_a_visible_by_loc_id = p_visible_by_loc_id
	_update_visibility()

func _get_loc_id_short_group(p_group: String) -> String:
	var prefix: String = "%s_" % p_group.to_upper()
	return _a_loc_id.trim_prefix(prefix)

func _get_loc_id_short_location(p_loc_id_short: String, p_location: String) -> String:
	var prefix: String = "%s_" % p_location.to_upper()
	return p_loc_id_short.trim_prefix(prefix)

func _has_location_prefix(p_group: String, p_location: String) -> bool:
	var prefix: String = "%s_%s_" % [p_group.to_upper(), p_location.to_upper()]
