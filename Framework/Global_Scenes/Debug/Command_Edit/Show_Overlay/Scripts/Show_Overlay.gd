...
class_name FWDebugCommandEditCommandShowOverlay
...
@onready var _a_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/VBox/Options/Type")
@onready var _a_Mask: FWDebugValueSelectImage = get_node("Window/Contents/Margin/HBox/VBox/Options/Mask")
@onready var _a_Anim: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/VBox/Options/Anim")
@onready var _a_Wait_Finish: FWDebugValueSelectBool = get_node("Window/Contents/Margin/HBox/VBox/Options/Wait_Finish")
