...
var _a_part: Node3D = null # Current part instance
var _a_power: bool = false
var _a_from_start: bool = true
var _a_finish_count: int = 0
...
func _change_part(p_idx: int) -> void:
	if _a_part != null:
...
func set_completed(p_power) -> void:
	_a_power = p_power
	for child: Node3D in _a_Parts.get_children():
...
func load_data(p_data: Dictionary) -> void:
	...
	_init_parts()
	for i: int in _a_Parts.get_child_count():
