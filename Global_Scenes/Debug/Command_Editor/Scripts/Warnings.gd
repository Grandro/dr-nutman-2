extends Control
class_name DebugCommandEditorWarnings

var _a_Warning_Entry_Scene: PackedScene = load("res://Global_Scenes/Debug/Command_Editor/Warning_Entry.tscn")
...
var _a_instance: DebugCommandEditorEntryCommand = null # Entry Instance
...
func open(p_pos: Vector2, p_instance: DebugCommandEditorEntryCommand) -> void:
	...
	for args: DebugCommandEditorEntryCommand.WarningArgsBase in warnings:
		...
		var instance: DebugCommandEditorWarningEntry = _a_Warning_Entry_Scene.instantiate()
...
func _on_Popup_hide() -> void:
	for child: DebugCommandEditorWarningEntry in _a_Entries.get_children():
		child.queue_free()
	hide()

func _on_Fix_pressed() -> void:
	var fix_warnings: DebugFixWarnings = Debug.get_fix_warnings()
