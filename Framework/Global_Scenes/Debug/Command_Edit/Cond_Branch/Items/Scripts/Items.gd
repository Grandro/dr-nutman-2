...
class_name FWDebugCommandEditCommandCondBranchItems

@onready var _a_Item: FWDebugItemSelect = get_node("VBox/Item")
@onready var _a_Amount: FWDebugValueSelectRange = get_node("VBox/Amount")
