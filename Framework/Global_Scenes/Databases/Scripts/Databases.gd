extends Node
class_name FWDatabases

signal data_loaded()

@export var _e_item_name_loc_id: String = "ITEMS_%s_%s_NAME"
@export var _e_item_desc_loc_id: String = "ITEMS_%s_%s_DESC"
...
func get_item_name_loc_id() -> String:
	return _e_item_name_loc_id

func get_item_desc_loc_id() -> String:
	return _e_item_desc_loc_id
...
func get_teleport_data(p_args: Array[StringName]) -> FWDestinationDataBase:
	var data: Dictionary = get_data(&"Maps")
	var map_args: FWMapData = data[p_args[0]]
	var destinations: Dictionary = map_args.get_destinations()
	var dest_args: FWDestinationDataBase = destinations[p_args[1]]
