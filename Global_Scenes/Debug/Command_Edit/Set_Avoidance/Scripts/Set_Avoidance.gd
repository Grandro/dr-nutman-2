...
class_name DebugCommandEditCommandSetAvoidance

@onready var _a_Avoidance: DebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Avoidance")
