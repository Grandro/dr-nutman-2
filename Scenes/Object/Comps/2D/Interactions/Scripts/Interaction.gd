extends Area2D
class_name CompInteractionsInteraction2D
...
@export var _e_cutscene_args: Array[Array] = []
...
func get_popup_pos() -> Vector2:
	return _a_shared.get_popup_pos()

func get_speech_bubble_pos() -> Vector2:
	return _a_shared.get_speech_bubble_pos()

func set_cutscene_args(p_args: Array) -> void:
	_a_shared.set_cutscene_args(p_args)

func get_cutscene_args() -> Array:
	return _a_shared.get_cutscene_args()

func set_cutscene_args_idx(p_args_idx: int) -> void:
	_a_shared.set_cutscene_args_idx(p_args_idx)

func get_cutscene_args_idx() -> int:
	return _a_shared.get_cutscene_args_idx()

func set_dialogue_args(p_args: Array) -> void:
	_a_shared.set_dialogue_args(p_args)

func get_dialogue_args() -> Array:
	return _a_shared.get_dialogue_args()

func set_dialogue_args_idx(p_args_idx: int) -> void:
	_a_shared.set_dialogue_args_idx(p_args_idx)
