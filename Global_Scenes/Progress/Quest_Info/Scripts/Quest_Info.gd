extends Control
class_name ProgressQuestInfo

const _a_CHAPTER_NAME_LOC_ID: String = "PROGRESS_%s_NAME"
const _a_TYPE_LOC_ID: String = "PROGRESS_QUEST_TYPE_%s"
const _a_STATUS_LOC_ID: String = "PROGRESS_QUEST_INFO_STATUS_%s"
...
func open(p_key: StringName, p_status: StringName) -> void:
	...
	var data: QuestData = Databases.get_data_entry(&"Quests", p_key)
