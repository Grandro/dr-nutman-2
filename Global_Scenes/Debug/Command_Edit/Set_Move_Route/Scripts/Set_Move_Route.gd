...
class_name DebugCommandEditCommandSetMoveRoute

@onready var _a_State: DebugCommandEditCommandSetMoveRouteState = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/State")
