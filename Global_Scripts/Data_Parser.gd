...
const a_LOC_PATH: String = "res://Localization/Localization.csv"
...
func write_loc_data(p_loc_ids: Array[StringName]) -> void:
	var file: FileAccess = FileAccess.open(a_LOC_PATH, FileAccess.WRITE)
...
func load_loc_data() -> Dictionary:
	var file: FileAccess = FileAccess.open(a_LOC_PATH, FileAccess.READ)
