...
class_name FWDebugExpressionEntryList

func instantiate_entry_(p_data: Dictionary, p_self_key: StringName = &"", p_name: String = "") -> FWDebugEntryListExpressionEntry:
	var instance: FWDebugEntryListExpressionEntry = instantiate_entry(p_name)
...
func instantiate_entry_from_data(p_data: Dictionary) -> FWDebugEntryListExpressionEntry:
