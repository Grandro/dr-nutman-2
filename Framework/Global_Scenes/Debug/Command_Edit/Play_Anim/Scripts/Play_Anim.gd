...
class_name FWDebugCommandEditCommandPlayAnim

@onready var _a_Keep_Dir: FWDebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Keep_Dir")
@onready var _a_Backwards: FWDebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Backwards")
@onready var _a_Anim_All: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Anim_All")
@onready var _a_Anim_Keep_Dir: FWDebugCommandEditCommandPlayAnimKeepDir = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Anim_Keep_Dir")
