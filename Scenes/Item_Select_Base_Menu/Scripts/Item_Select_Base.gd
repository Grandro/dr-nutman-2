...
class_name ItemSelectBase

signal item_pressed(p_instance: ItemEntryInventory)
...
var _a_Item_Entry_Scene: PackedScene = preload("res://Scenes/Item_Entry/Item_Entry_Inventory.tscn")

const _a_TAB_ENTRY_SCENE_PATH: String = "res://Scenes/Item_Select_Base_Menu/Tab_Entry/%s.tscn"

@onready var _a_Sort_By: SortBy = get_node("Grid/List/Options/Sort_By")
@onready var _a_Search: Search = get_node("Grid/List/Options/Search")
@onready var _a_Items: TabContainer = get_node("Grid/List/Items")
@onready var _a_Info: ItemSelectInfo = get_node("Grid/HBox/Info")

var _a_instance: ItemEntryInventory = null # Selected item instance
var _a_items: Dictionary[StringName, ItemEntryInventory] = {} # Match key to instance
var _a_tab_instances: Dictionary[StringName, ItemSelectTabEntry] = {} # Match key to instance
...
func _ready() -> void:
	...
	for i: int in _e_tabs.size():
		...
		var instance: ItemSelectTabEntry = scene.instantiate()
...
func _clear_items() -> void:
	for tab_instance: ItemSelectTabEntry in _a_tab_instances.values():
...
func _grab_first_focus() -> void:
	var curr_tab: ItemSelectTabEntry = _a_Items.get_current_tab_control()
	var first: ItemEntryInventory = curr_tab.get_first_item_curr()
	if first == null:
		return
...
func _selected_item_changed(p_instance: ItemEntryInventory) -> void:
...
func _on_Item_pressed(p_instance: ItemEntryInventory) -> void:
