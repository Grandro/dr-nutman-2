...
class_name FWDebugCommandEditCommandShowDialogue

@onready var _a_Key_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/VBox/VBox/Key_Type")
@onready var _a_Key: FWDebugCommandEditCommandShowDialogueKey = get_node("Window/Contents/Margin/VBox/VBox/Key")
@onready var _a_Process_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/VBox/VBox/Process_Type")
@onready var _a_Start_Idx: FWDebugValueSelectNum = get_node("Window/Contents/Margin/VBox/VBox/Start_Idx")
@onready var _a_End_Idx: FWDebugValueSelectNum = get_node("Window/Contents/Margin/VBox/VBox/End_Idx")
@onready var _a_Layer: FWDebugValueSelectNum = get_node("Window/Contents/Margin/VBox/VBox/Layer")
@onready var _a_Fade_Out: FWDebugValueSelectBool = get_node("Window/Contents/Margin/VBox/VBox/Fade_Out")
