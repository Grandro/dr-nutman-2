...
class_name FWDebugCommandEditCommandMoveFreeCamera

@onready var _a_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Type")
@onready var _a_Interpolate: FWDebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Interpolate")
@onready var _a_Speed: FWDebugValueSelectSlider = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Speed")
@onready var _a_Trans_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Trans_Type")
@onready var _a_Ease_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Ease_Type")
@onready var _a_End_Object: FWDebugObjectSelect = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/End_Object")
@onready var _a_Change_Camera: FWDebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Change_Camera")
@onready var _a_Wait_Finish: FWDebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Wait_Finish")

var _a_type: StringName = &"" # Move_Route/Object_To_Object/Object_To_Point
...
func open(p_instance: FWDebugCommandEditorEntryBase, p_data: Dictionary, p_res_data: Dictionary) -> void:
	...
	if has_object && p_data.is_empty():
		var key: StringName = p_res_data[&"Misc"][&"Free_Camera"][&"Object"]
...
func _selected_type_changed() -> void:
	...
	match type:
		...
		&"Object_To_Object":
			var interpolate_pressed: bool = _a_Interpolate.is_pressed()
			_a_Path_Points.hide()
...
func _interpolate_pressed_changed() -> void:
...
func _selected_object_changed_type(p_type: StringName) -> void:
	#if _a_object != null:
...
func _handle_mouse_left(p_point_vec: Variant) -> void:
	match _a_type:
		&"Move_Route":
			super(p_point_vec)
		
		&"Object_To_Point":
			var curr_point_vec: Variant = _a_Point.get_point_vec()
...
func _adjust_object_properties(p_properties: Dictionary) -> void:
	...
	match _a_type:
		...
		&"Object_To_Object":
			var end_object: Node = _a_End_Object.get_selected_value()
			var end_object_key: StringName = _a_End_Object.get_selected_key()
			var pos: Variant = end_object.get_position()
			if end_object_key != &"$Free_Camera":
				var camera: Node = end_object.comph().get_comp("Camera")
...
func _on_End_Object_selected() -> void:
	_selected_object_changed_type(&"End")
