...
class_name DebugDialoguesAttributeText

@onready var _a_General: DebugDialoguesAttributesTabGeneralTypes = get_node("General")
@onready var _a_Object: DebugDialoguesAttributesTextTabObject = get_node("Object")
@onready var _a_Pos: DebugDialoguesAttributesTextTabPos = get_node("Pos")
@onready var _a_Vox: DebugDialoguesAttributesTabVox = get_node("Vox")
