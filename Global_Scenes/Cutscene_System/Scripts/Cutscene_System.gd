...
@export var _e_thread_paths: Dictionary = {}

var _a_Branch_Scene: PackedScene = preload("res://Global_Scenes/Cutscene_System/Branch.tscn")
...
func cutscene(p_key: StringName, p_entry_key: StringName, p_process_type: StringName = &"Main", p_key_type: StringName = &"Map") -> void:
	...
	var instance: CutsceneBranch = _instantiate_branch(curr_scene, data, p_process_type, p_key, p_entry_key, p_key_type)
...
func cutscene_from_data(p_curr_scene: Node, p_data: Array[Dictionary], p_process_type: StringName, p_skip_idxs: Array[int] = []) -> void:
	...
	var instance: CutsceneBranch = _instantiate_branch(p_curr_scene, args, p_process_type, &"", &"", &"", p_skip_idxs)
	_a_Branches.add_child(instance)
...
func _branch_completed(p_instance: CutsceneBranch) -> void:
...
func _instantiate_branch(p_curr_scene: Node, p_data: Array[Dictionary], p_process_type: StringName, p_key: StringName,
						 p_entry_key: StringName, p_key_type: StringName, p_skip_idxs: Array[int] = []) -> CutsceneBranch:
...
func set_cutscene_completed_cb(p_key: StringName, p_entry_key: StringName, p_completed_cb: Callable) -> void:
	var instance: CutsceneBranch = _a_branches[p_key][p_entry_key]
...
func get_cutscene_caller(p_key: StringName, p_entry_key: StringName) -> Node:
	var branch: CutsceneBranch = _a_branches[p_key][p_entry_key]
...
func _on_Branch_tree_exiting(p_instance: CutsceneBranch) -> void:
	var key: StringName = p_instance.get_key()
	if key.is_empty():
		return
...
func _on_Branch_completed(p_instance: CutsceneBranch) -> void:
	_branch_completed(p_instance)

func _on_Branch_request_exit(p_instance: CutsceneBranch) -> void:
	_branch_completed(p_instance)
