extends Control
class_name FWProgressLootInfo

@onready var _a_Rewards: FWLootRewardsLoot = get_node("Info/Margin/VBox/Rewards")
@onready var _a_Coins: FWLootCoins = get_node("Info/Coins")
