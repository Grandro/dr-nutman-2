...
class_name FWContextMenuOptionEntry
...
var _a_Context_Menu_Scene: PackedScene = load("uid://bdm8bdyt8jrh")
...
var _a_sub_menu: FWContextMenu = null # Instance of sub Context_Menu
...
var _a_options: Dictionary[StringName, FWContextMenuOptionEntryData] # Options of _a_sub_menu
...
func set_options(p_options: Dictionary[StringName, FWContextMenuOptionEntryData]) -> void:
