...
class_name DebugCutscenes

@onready var _a_Editor: DebugCommandEditor = get_node("VBox/HBox/VBox/Editor")
...
func _on_Editor_option_test_selected(p_instance: DebugCommandEditorEntryBase) -> void:
