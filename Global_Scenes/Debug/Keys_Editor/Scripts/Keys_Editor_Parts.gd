extends DebugKeysEditor
class_name DebugKeysEditorParts

@onready var _a_VBox: VBoxContainer = get_node("VBox")
@onready var _a_Parts: DebugTypeEntryList = get_node("VBox/HBox/Parts")
...
var _a_part: DebugEntryListEntry = null
...
func _focus_first_part() -> void:
	var first: DebugEntryListEntry = _a_Parts.get_entry(0)
...
func _on_Parts_entry_select_pressed(p_instance: DebugEntryListEntry) -> void:
	_update_part_data()
