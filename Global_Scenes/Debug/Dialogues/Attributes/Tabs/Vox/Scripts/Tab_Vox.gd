...
class_name DebugDialoguesAttributesTabVox

@onready var _a_Object: DebugObjectSelect = get_node("Margin/HSplit/Left/Object")
@onready var _a_Custom_Heading: Label = get_node("Margin/HSplit/Left/Custom/VBox_1/Heading")
...
@onready var _a_Custom_File_Heading: Label = get_node("Margin/HSplit/Left/Custom/VBox_2/File/Heading")
@onready var _a_Custom_File_Audio: DebugAudioSelect = get_node("Margin/HSplit/Left/Custom/VBox_2/File/Audio")
@onready var _a_Custom_Pitch_Heading: Label = get_node("Margin/HSplit/Left/Custom/VBox_2/Pitch/Heading")
@onready var _a_Custom_Pitch: DebugFloatEdit = get_node("Margin/HSplit/Left/Custom/VBox_2/Pitch/Value")
