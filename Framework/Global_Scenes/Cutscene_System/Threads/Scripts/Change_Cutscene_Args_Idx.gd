...
class_name FWCutsceneThreadChangeCutsceneArgsIdx
...
func _process_command() -> void:
	...
	match type:
		&"Set": interactions_comp.set_interaction_cutscene_args_idx(idx, args_idx)
		&"Increase": interactions_comp.increase_interaction_cutscene_args_idx(idx, args_idx)
		&"Decrease": interactions_comp.decrease_interaction_cutscene_args_idx(idx, args_idx)
