extends FWDebugCommandEditPreviewBaseDimensions
class_name FWDebugCommandEditPreviewDimensions3D

signal nav_map_ready()

var _a_preview_vp: FWVP
var _a_point: FWDebugValueSelectPoint3D
...
func update_point() -> void:
	var draw_grid: FWDebugCommandEditDrawGrid3D = _a_entity.get_draw_grid_instance()
