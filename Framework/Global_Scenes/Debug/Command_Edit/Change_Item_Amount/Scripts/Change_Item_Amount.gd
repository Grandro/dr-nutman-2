...
class_name FWDebugCommandEditCommandChangeItemAmount

@onready var _a_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/VBox/Type")
@onready var _a_Item: FWDebugItemSelect = get_node("Window/Contents/Margin/VBox/Item")
@onready var _a_Amount: FWDebugValueSelectNum = get_node("Window/Contents/Margin/VBox/Amount")
