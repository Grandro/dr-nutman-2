extends Node3D
class_name CompInteractions3D

signal interacted()
signal interaction_activated(p_area: CompInteractionsInteraction3D)
...
func interaction(p_area: CompInteractionsInteraction3D) -> void:
	_a_shared.interaction(p_area)

func interaction_update(p_dir: StringName) -> void:
	_a_shared.interaction_update(p_dir)

func interaction_activate(p_area: CompInteractionsInteraction3D, p_dir: StringName) -> void:
	_a_shared.interaction_activate(p_area, p_dir)

func interaction_deactivate(p_area: CompInteractionsInteraction3D) -> void:
...
func _on_Shared_interaction_activated(p_area: CompInteractionsInteraction3D) -> void:
