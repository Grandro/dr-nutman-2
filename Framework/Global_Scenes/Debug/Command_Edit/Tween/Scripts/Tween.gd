...
class_name FWDebugCommandEditCommandTween

@export var _e_point_scene: PackedScene = null

@onready var _a_Comp: FWDebugCompSelect = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Comp")
@onready var _a_Property: FWDebugCommandEditCommandTweenPropertySelect = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Property")
@onready var _a_Interpolate: FWDebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Interpolate")
@onready var _a_Duration: FWDebugValueSelectFloat = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Duration")
...
@onready var _a_Start_Value: FWDebugValueSelectEdit = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Start_Value")
@onready var _a_End_Value: FWDebugValueSelectEdit = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/End_Value")
