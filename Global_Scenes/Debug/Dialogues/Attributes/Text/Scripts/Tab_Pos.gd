...
class_name DebugDialoguesAttributesTextTabPos

const _a_POS_LOC_ID: String = "POS_%s"
const _a_NAME_TYPES: Array[StringName] = [&"Top", &"Bottom"]

@onready var _a_Pos_Type_Heading: Label = get_node("Margin/HSplit/Left/Pos/Type/Heading")
...
@onready var _a_Pos_Custom_Heading: Label = get_node("Margin/HSplit/Left/Pos/Custom/Heading")
@onready var _a_Pos_Custom: DebugValueEdit = get_node("Margin/HSplit/Left/Pos/Custom/Value")
@onready var _a_Pos_Name_Type_Heading: Label = get_node("Margin/HSplit/Left/Pos/Name_Type/Heading")
...
@onready var _a_Show_Arrow_Heading: Label = get_node("Margin/HSplit/Left/Show_Arrow/Heading")
