...
class_name DebugCommandEditCommandChangeDir
...
@onready var _a_Fixed_Dir: DebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Dir/Fixed")
@onready var _a_Look_HBox: HBoxContainer = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Dir/Look")
@onready var _a_Look_Type: DebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Dir/Look/Type")
@onready var _a_Look_Object: DebugObjectSelect = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Dir/Look/Object")
@onready var _a_Look_Degrees: DebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Dir/Look_Degrees")
