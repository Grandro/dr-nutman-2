...
@onready var _a_Master: FWDebugValueSelectSlider = get_node("Master")
@onready var _a_BGM: FWDebugValueSelectSlider = get_node("BGM")
@onready var _a_BGS: FWDebugValueSelectSlider = get_node("BGS")
@onready var _a_SFX: FWDebugValueSelectSlider = get_node("SFX")
