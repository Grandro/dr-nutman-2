...
const _a_MINI_BUST_SCENE_PATH: String = "res://Framework/Global_Scenes/Main_Menu/Sub_Menus/Journal/File_Entry/Mini_Busts/%s.tscn"

@onready var _a_Mini_Busts: HBoxContainer = get_node("Mini_Busts")
@onready var _a_Margin: MarginContainer = get_node("Nine/Margin")
@onready var _a_Play_Time: Label = get_node("Nine/Margin/Grid/Play_Time/Value")
@onready var _a_Amethysts: Label = get_node("Nine/Margin/Grid/Amethysts/Value")
@onready var _a_Location: Label = get_node("Nine/Margin/Grid/Location/Value")
@onready var _a_Select: Button = get_node("Nine/Select")
