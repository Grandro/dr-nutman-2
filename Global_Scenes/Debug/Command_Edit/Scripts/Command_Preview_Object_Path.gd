...
class_name DebugCommandEditCommandPreviewObjectPath

@export var _e_selected_color: Color = Color(1.0, 0.84, 0.0)
@export var _e_normal_color: Color = Color.WHITE

const _a_PATH_PATH: String = "res://Global_Scenes/Debug/Sprites/Path/%s.png"

@onready var _a_Path_Points: DebugPointEntryList = get_node("Window/Contents/Margin/HBox/Path_Points")

var _a_path_point: DebugEntryListPointEntry = null # Currently selected path point
...
func _on_Gen_Path_path_updated() -> void:
	...
	for nav_mesh_path_point: Variant in nav_mesh_path_points:
		...
		var instance: DebugEntryListPointEntry = _a_Path_Points.instantiate_entry_(nav_mesh_path_point)
...
func _on_Path_Points_entry_select_pressed(p_instance: DebugEntryListPointEntry) -> void:
...
func _on_Path_Points_entry_deleting(p_instance: DebugEntryListPointEntry) -> void:
	var nav_mesh_path_point: Variant = p_instance.get_point()
	var path_point: Variant = _a_gen_path.get_path_point(nav_mesh_path_point)
