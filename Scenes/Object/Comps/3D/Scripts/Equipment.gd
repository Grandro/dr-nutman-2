...
var _a_Shared: GDScript = preload("res://Scenes/Object/Comps/Equipment/Scripts/Shared.gd")

var _a_shared: CompEquipmentShared
...
func _on_Shared_equipped(p_group: StringName, p_key: StringName) -> void:
	var instance: Equipable3D = _a_shared.get_equipable_instance(p_group, p_key)
