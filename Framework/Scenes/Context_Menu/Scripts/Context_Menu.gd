...
var _a_options: Dictionary[StringName, FWContextMenuOptionEntry] = {} # Match option key to Option_Entry instance
...
func _create_options() -> void:
	...
	for option: StringName in _e_options_order:
		var args: FWContextMenuOptionEntryData = _e_options[option]
