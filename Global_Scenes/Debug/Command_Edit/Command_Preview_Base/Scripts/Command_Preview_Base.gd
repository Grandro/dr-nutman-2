...
class_name DebugCommandEditCommandPreviewBase
...
@onready var _a_Preview: DebugPreview = get_node("Window/Contents/Margin/HBox/Left/Preview")
...
var _a_dimensions: DebugCommandEditPreviewBaseDimensions

var _a_preview_vp: VP = null
...
func get_preview_vp_instance() -> VP:
