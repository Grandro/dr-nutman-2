extends DebugCommandEditCommandPreviewObjectPath
class_name DebugCommandEditCommandMoveFreeCamera
...
@onready var _a_End_Object: DebugObjectSelect = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/End_Object")
@onready var _a_Change_Camera: DebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Change_Camera")
