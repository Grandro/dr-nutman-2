...
class_name DebugCommandEditorEntryBase
...
@onready var _a_Main: DebugCommandEditorBranchMain = get_node("HBox/VBox/Branches/Main")

var _a_parents: Array[DebugCommandEditorEntryBase] = [] # Every entry parent of this entry
...
func set_process_visible(p_branch_idx: int, p_visible: bool) -> void:
	var instance: DebugCommandEditorBranchBase = _a_Branches.get_child(p_branch_idx)
...
func get_branch_idxs() -> Array[int]:
	var idxs: Array[int] = []
	for parent: DebugCommandEditorEntryBase in _a_parents:
...
func set_parents(p_parents: Array[DebugCommandEditorEntryBase]) -> void:
	_a_parents = p_parents

func get_parents() -> Array[DebugCommandEditorEntryBase]:
	return _a_parents
