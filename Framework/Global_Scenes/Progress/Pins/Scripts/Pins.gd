...
class_name FWProgressPins

var _a_Quest_Icon: Texture2D = preload("uid://dk0aud1w482am")

@onready var _a_Menu: TabContainer = get_node("Menu")
@onready var _a_No_Pins: Label = get_node("Menu/Quests/No_Pins")
@onready var _a_Quest_List: FWDebugQuestEntryList = get_node("Menu/Quests/Quest_List")
...
func pin_quest(p_key: StringName) -> void:
	var instance: FWDebugEntryListQuestEntry = _a_Quest_List.instantiate_entry_(p_key)
...
func _on_Quest_List_entry_select_pressed(p_instance: FWDebugEntryListQuestEntry) -> void:
