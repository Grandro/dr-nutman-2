extends FWDebugRangeEdit
class_name FWDebugValueSelectRangeEdit

@onready var _a_Min_Var_Select: FWDebugValueSelectVarSelect = get_node("Min/Var_Select")
@onready var _a_Max_Var_Select: FWDebugValueSelectVarSelect = get_node("Max/Var_Select")
...
func _get_save_data(p_var_select: FWDebugValueSelectVarSelect, p_value: FWDebugNumEdit) -> Dictionary:
	var data: Dictionary = {}
...
func _load_data(p_data: Dictionary, p_var_select: FWDebugValueSelectVarSelect, p_value: FWDebugNumEdit) -> void:
...
func _on_Var_Select_active_toggled(p_toggled: bool, p_instance: FWDebugNumEdit) -> void:
