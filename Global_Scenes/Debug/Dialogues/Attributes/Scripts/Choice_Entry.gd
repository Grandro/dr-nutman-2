...
class_name DebugDialoguesAttributesChoiceEntry
...
@onready var _a_Loc_ID_Desc: Label = get_node("HBox/VBox/Loc_ID/Desc")
@onready var _a_Loc_ID: Button = get_node("HBox/VBox/Loc_ID/Select")
@onready var _a_Value_Desc: Label = get_node("HBox/VBox/Value/Desc")
@onready var _a_Value: DebugValueEdit = get_node("HBox/VBox/Value/Value_Edit")
