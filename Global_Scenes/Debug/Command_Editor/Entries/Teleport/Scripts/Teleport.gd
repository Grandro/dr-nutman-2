...
class_name DebugCommandEditorEntryTeleport

@onready var _a_Battle_Won: DebugCommandEditorBranchBase = get_node("HBox/VBox/Branches/Battle_Won")
@onready var _a_Battle_Lost: DebugCommandEditorBranchBase = get_node("HBox/VBox/Branches/Battle_Lost")
