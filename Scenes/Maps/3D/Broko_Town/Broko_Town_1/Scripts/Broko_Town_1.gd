...
@onready var _a_Right_On_The_Nut: FWMiniGameBase = get_node("Mini_Games/Right_On_The_Nut")
@onready var _a_Squirrel_Fishing: FWMiniGameBase = get_node("Mini_Games/Squirrel_Fishing")
...
func load_data_init() -> void:
	...
	for i: int in children.size():
		var child: FWCharacter3DObject = children[i]
