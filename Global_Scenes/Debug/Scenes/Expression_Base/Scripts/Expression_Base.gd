...
class_name DebugExpressionBase
...
@onready var _a_Instance_Desc: Label = get_node("VBox/VBox/HBox/Instance/Desc")
...
@onready var _a_Comp_Desc: Label = get_node("VBox/VBox/Comp/Desc")
@onready var _a_Comp: OptionButton = get_node("VBox/VBox/Comp/Options")
@onready var _a_Expression_Desc: Label = get_node("VBox/VBox/Expression/Desc")
...
var _a_attr_select: DebugAttrSelect
