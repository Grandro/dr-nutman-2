...
var _a_Main_Scene: PackedScene = preload("res://Global_Scenes/Main_Menu/Menus/Main/Main.tscn")
...
func open_menu(p_scene: PackedScene) -> void:
	...
	var instance: MainMenuMenuBase = _instantiate_menu(p_scene)
	var data: Dictionary = {}
...
func _instantiate_menu(p_scene: PackedScene) -> MainMenuMenuBase:
	var instance: MainMenuMenuBase = p_scene.instantiate()
...
func reset() -> void:
	...
	for key: StringName in main_menu_data[&"Sub_Menus"]:
		var res: SubMenuData = main_menu_data[&"Sub_Menus"][key]
		sub_menu_data[key] = {}
