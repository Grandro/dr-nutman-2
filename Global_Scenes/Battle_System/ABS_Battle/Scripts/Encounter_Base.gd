...
@export var _e_enemy_scenes: Array[PackedScene] = []

@onready var _a_Area: Area3D = get_node("Area")
@onready var _a_Collision: CollisionShape3D = get_node("Area/Collision")
@onready var _a_Respawn: Timer = get_node("Respawn")
...
func set_party_members(p_members) -> void:
...
func is_inside_area(p_point) -> bool:
