extends FWDebugCommandEditCommandPreviewBase
class_name FWDebugCommandEditCommandPreviewObject

var _a_Outline_2D: ShaderMaterial = preload("uid://bqc55y1g0cpkv")
var _a_Outline_Display_3D: ShaderMaterial = preload("uid://d1pplu8786jt1")

@onready var _a_Object: FWDebugObjectSelect = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Object")
...
func _create_objects() -> void:
	var preview_vp: FWVP = get_preview_vp_instance()
