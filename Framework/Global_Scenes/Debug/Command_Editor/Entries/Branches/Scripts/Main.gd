extends FWDebugCommandEditorBranchBase
class_name FWDebugCommandEditorBranchMain

signal warning_pressed()

var _a_Mark_Default_Image: Texture2D = preload("uid://r6vb6j06pcdg")
var _a_Mark_Test_Image: Texture2D = preload("uid://dy6yxomdqftk5")
...
func add_args_child(p_child: FWDebugCommandEditorArgEntry) -> void:
