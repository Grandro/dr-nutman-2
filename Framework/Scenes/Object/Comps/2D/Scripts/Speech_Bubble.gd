extends Node2D
class_name FWCompSpeechBubble2D
...
@onready var _a_Speech_Bubble_UI: FWCompSpeechBubbleUI = get_node("Speech_Bubble_UI")
...
func init(p_entities: Array[Node]) -> void:
	...
	if entity_comph.has_comp("Interactions"):
		var interactions_comp: FWCompInteractions2D = entity_comph.get_comp("Interactions")
...
func _on_Interactions_interaction_activated(p_area: FWCompInteractionsInteraction2D) -> void:
