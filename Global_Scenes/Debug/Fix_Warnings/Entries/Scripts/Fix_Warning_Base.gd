...
class_name DebugFixWarningsEntryBase
...
var _a_warning: DebugCommandEditorEntryCommand.WarningArgsBase # Warning instance
...
func set_warning(p_warning: DebugCommandEditorEntryCommand.WarningArgsBase) -> void:
