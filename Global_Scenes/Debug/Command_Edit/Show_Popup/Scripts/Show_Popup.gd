...
class_name DebugCommandEditCommandShowPopup

@onready var _a_Type: DebugCommandEditCommandShowPopupType = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Type")
