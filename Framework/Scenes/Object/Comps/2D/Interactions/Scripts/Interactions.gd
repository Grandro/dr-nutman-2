extends Node2D
class_name FWCompInteractions2D

signal interacted()
signal interacted_empty()
signal interaction_activated(p_area: FWCompInteractionsInteraction2D)
...
var _a_Shared: GDScript = preload("uid://db1h73l84jn7c")
...
func interaction(p_area: FWCompInteractionsInteraction2D) -> void:
	_a_shared.interaction(p_area)

func interaction_update(p_dir: StringName) -> void:
	_a_shared.interaction_update(p_dir)

func interaction_activate(p_area: FWCompInteractionsInteraction2D, p_dir: StringName) -> void:
	_a_shared.interaction_activate(p_area, p_dir)

func interaction_deactivate(p_area: FWCompInteractionsInteraction2D) -> void:
...
func _on_Shared_interaction_activated(p_area: FWCompInteractionsInteraction2D) -> void:
