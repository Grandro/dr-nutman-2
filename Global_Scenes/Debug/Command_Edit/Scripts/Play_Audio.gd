...
class_name DebugCommandEditCommandPlayAudio

@onready var _a_Audio_Type: DebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Audio_Type")
@onready var _a_Type: DebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Type")
@onready var _a_Audio: DebugValueSelectAudio = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Audio")
@onready var _a_Volume: DebugValueSelectFloat = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Volume")
@onready var _a_Pitch: DebugValueSelectFloat = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Pitch")
@onready var _a_Max_Distance: DebugValueSelectFloat = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Max_Distance")
