...
class_name DebugValueEditEntryList

@export var _e_type_editable: bool = false
@export var _e_value_editable: bool = false

func instantiate_entry_(p_value: Variant = "", p_name: String = "") -> DebugEntryListValueEditEntry:
	var instance: DebugEntryListValueEditEntry = instantiate_entry(p_name)
...
func instantiate_entry_from_data(p_data: Dictionary) -> DebugEntryListValueEditEntry:
...
func set_type_editable(p_type_editable: bool) -> void:
	...
	for child: DebugEntryListValueEditEntry in _a_VBox.get_children():
...
func _on_Add_pressed() -> void:
	var instance: DebugEntryListValueEditEntry = instantiate_entry_()
	add_entry(instance)
