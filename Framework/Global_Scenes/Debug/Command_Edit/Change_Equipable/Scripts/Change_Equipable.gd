...
class_name FWDebugCommandEditCommandChangeEquipable

@onready var _a_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Type")
@onready var _a_Equipable_Group: FWDebugCommandEditCommandChangeEquipableGroup = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Equipable_Group")
@onready var _a_Equipable: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Equipable")
...
func _selected_type_changed() -> void:
	var type: StringName = _a_Type.get_selected_key()
	_a_Equipable.set_visible(type == &"Equip")
