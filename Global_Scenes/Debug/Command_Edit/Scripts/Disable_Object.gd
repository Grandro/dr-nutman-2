...
class_name DebugCommandEditCommandDisableObject

@onready var _a_Disable: DebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Disable")
