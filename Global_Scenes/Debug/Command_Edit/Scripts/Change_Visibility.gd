...
class_name DebugCommandEditCommandChangeVisibility

@onready var _a_Visible: DebugValueSelectBool = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Visible")
