...
class_name FWDebugCommandEditCommandChangeArgsBase

@onready var _a_Type: FWDebugValueSelectOptions = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Type")
@onready var _a_Idx: FWDebugCommandEditValueSelectIdx = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Idx")
@onready var _a_Value: FWDebugValueSelect = get_node("Window/Contents/Margin/HBox/Right/Options/VBox/Value")
